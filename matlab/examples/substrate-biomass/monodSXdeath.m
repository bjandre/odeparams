function ydot = monodSXdeath(t,x)
global OPEuser
%
% $Id: monodSXdeath.m 5 2008-11-18 04:11:57Z bjandre $
%
...
% the monod function with death
% dx/dt = muMax * x * s / (Ks + s) - b
% ds/dt = -muMax/Y * x *s / (Ks + s)
% params(1) = muMax
% params(2) = Ks
% params(3) = Y
% params(4) = b = death coefficient
